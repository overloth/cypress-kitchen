...
context("My first test", () => {
  ...
  //   cy.findByPlaceholderText("Email").type("email@test.com", { sensitive: true });
  // });
  ...
  //       .find("li")
  //       .first()
  //       .should("not.have.class", "active").find('a').should('have.attr', 'href', '/commands/querying');
  //   });
  ...
  //   cy.visit('/commands/actions')
  //   cy.get('.action-checkboxes [type="checkbox"]').eq(1).check( ).should('be.checked')
  // })
});
